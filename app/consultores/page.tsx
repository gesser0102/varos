...
import { ConsultoresTable } from '@/components/dashboard/ConsultoresTable'
import { TableSkeleton } from '@/components/dashboard/TableSkeleton'
import { ConsultoresStatsCard } from '@/components/dashboard/ConsultoresStats'
...
export default async function ConsultoresPage(props: {
  ...
  return (
    <div className="min-h-screen bg-[#131313] text-white">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">Consultores</h1>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-8 mb-6 sm:mb-8">
          <Suspense fallback={
            ...
            <ConsultoresStatsCard />
          </Suspense>

          <LoadingLink
            href="/usuarios/novo"
            className="bg-[#1B3F1B] hover:bg-[#224d22] border border-[#222729] px-4 py-3 sm:py-4 rounded-lg flex items-center justify-center gap-2 transition-colors w-full lg:w-auto"
          >
        ...
        <div className="mt-6 sm:mt-8">
          <Disclaimer>
            💡 <span className="text-gray-300">Dica:</span> Clique em qualquer consultor na tabela para editá-lo
          </Disclaimer>

          <Suspense fallback={<TableSkeleton />}>
            <ConsultoresTable searchParams={searchParams} />
          </Suspense>
        </div>
      </div>
    </div>
